...
export declare class SharedGroupController {
    private readonly sharedGroupService;
    constructor(sharedGroupService: SharedGroupService);
    ...
    joinGroup(userId: string, code: string): Promise<({
        members: ({
            user: {
                nombre: string;
                email: string;
    ...
    shareDevice(groupId: number, adultoId: number, userId: number): Promise<{
        adulto: {
            dispositivo: {
                id_dispositivo: string;
                online_status: boolean;
    ...
    unshareDevice(groupId: number, adultoId: number, userId: number): Promise<{
        message: string;
    }>;
    getGroupDevices(groupId: number): Promise<({
        adulto: {
            dispositivo: {
                id_dispositivo: string;
                online_status: boolean;
