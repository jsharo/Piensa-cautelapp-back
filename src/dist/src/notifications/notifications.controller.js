...
const esp32_webhook_dto_1 = require("./dto/esp32-webhook.dto");
let NotificationsController = NotificationsController_1 = class NotificationsController {
    ...
    receiveESP32(dto) {
        ...
        if (dto.ubicacion)
            console.log('📍 Ubicación:', dto.ubicacion);
        if (dto.mensaje || dto.mensaje_adicional)
            console.log('💬 Mensaje:', dto.mensaje ?? dto.mensaje_adicional);
...
__decorate([
    (0, common_1.Post)('webhook/esp32'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [esp32_webhook_dto_1.ESP32WebhookDto]),
    __metadata("design:returntype", void 0)
], NotificationsController.prototype, "receiveESP32", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
